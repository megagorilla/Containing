...
public class ControlHandler
{
    ...
    public ArrayList<AGV> agvShipQueue = new ArrayList<AGV>();
	public void requestAGVToSeaship(){
		...
		this.sendAGVToSeaShip(agv.agvId, list, "c2");
	}
	
	public ArrayList<AGV> agvBargeQueue = new ArrayList<AGV>();
	public void requestAGVToBarge()
	{
		AGV agv = AGVHandler.getInstance().getFreeAGV();
		List<Vector3f> list = new ArrayList<Vector3f>();
		int i = Integer.parseInt(agv.currentLocation.split("_")[1]);
		...
		list.add(new Vector3f(267.5f, 0.0f, -760 + 40 * location.parkID));
		list.add(new Vector3f(303.5f, 0.0f, -760 + 40 * location.parkID));
		list.add(new Vector3f(303.5f, 0.0f, 390));
		list.add(new Vector3f(360, 0.0f, 390));
		this.sendAGVToBarge(agv.agvId, list, "b2");
	}
	
	public void sendAGVToSeaShip(int id, List<Vector3f> list, String destination)
	{
		AGV agv = AGVHandler.getInstance().getAGV(id);
		UpdateMessage message = new UpdateMessage(Integer.toString(id));
	...
	public void sendAGVToBarge(int id, List<Vector3f> list, String destination)
	{
		AGV agv = AGVHandler.getInstance().getAGV(id);
		UpdateMessage message = new UpdateMessage(Integer.toString(id));
